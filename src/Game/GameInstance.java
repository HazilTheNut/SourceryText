...
public class GameInstance {
    ...
    private ArrayList<PathPoint> pointLog; //A more raw list of points used during path-finding algorithm
    private HashMap<Long, Integer> entityPathMap; //A map that matches entity UIDs to distances (# of steps required) from the player. Makes things super convenient for entities to check the path points
